import "cypress-axe";
import "cypress-pipe";
import type { A11yOptions } from "./cypress-helper";
...
export class Assertable<T> {
   ...
   * @param options Set of options passed into rules or checks, temporarily modifying them.
